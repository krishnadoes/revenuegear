...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-[#502274] font-extrabold tracking-wide mt-3 text-lg", className)}>
      {children}
    </h4>
  );
};
export const CardDescription = ({
  ...
  return (
    <p
      className={cn("mt-8 text-purple-900 tracking-wide leading-relaxed text-md font-semibold", className)}>
      {children}
    </p>
  );
};
